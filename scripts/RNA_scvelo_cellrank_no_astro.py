...
adata_combined = sc.read('data/RNA/RNA_all_velo_v0raw.h5ad')


#### Subset and join with processed data ####
# rna = sc.read('data/RNA/RNA_all_srt_v2.2matched.h5ad')
rna = sc.read('data/RNA/RNA_all_srt_v3noastro.h5ad')
...
rna_use.write('data/RNA/RNA_noastro_v3velo.h5ad')


#### Filter and preproc ####
rna_use = sc.read('data/RNA/RNA_noastro_v3velo.h5ad')
...
p.figure.savefig('plots/RNA/rna_noastro_velo_umap.png')
...
p.figure.savefig('plots/RNA/rna_noastro_velo_stream_umap.png')

rna_use.write('data/RNA/RNA_noastro_v3.1velo.h5ad')


#### Compute pseudotime ####
rna_use = sc.read('data/RNA/RNA_noastro_v3.1velo.h5ad')
...
p.figure.savefig('plots/RNA/rna_noastro_velo_pt_umap.png')
...
p.figure.savefig('plots/RNA/rna_noastro_velo_pt_ranks_umap.png')
...
p.figure.savefig('plots/RNA/rna_noastro_velo_terminal_umap.png')
...
p = sc.pl.scatter(rna_use, basis='cssumap', color=['to_ctx','to_dien','to_rhom','to_mesen','to_retina'], show=False)
p[0].figure.savefig('plots/RNA/rna_noastro_velo_cellrank_probs_umap.png')
...
p = sc.pl.scatter(rna_use, basis='cssumap', color=['to_ctx_ranks','to_dien_ranks','to_rhom_ranks','to_mesen_ranks','to_retina_ranks'], show=False)
...
cellrank_meta = rna_use.obs[[
    ...
    'to_ctx_ranks', 'to_dien_ranks', 'to_rhom_ranks', 'to_mesen_ranks', 'to_retina_ranks', 'to_ctx', 'to_dien', 'to_rhom',
    'to_mesen', 'to_retina']]
cellrank_meta.to_csv('data/RNA/cellrank/RNA_noastro_cellrank_probs.tsv', sep='\t')

trans_mat = combined_kernel._transition_matrix
sp.io.mmwrite('data/RNA/cellrank/RNA_noastro_velo_cr_transition.mtx', trans_mat)
...
sp.io.mmwrite('data/RNA/cellrank/RNA_noastro_velo_paga_connectivities.mtx', con_mat)

rna_use.obs = rna_use.obs.drop('terminal_states_probs', axis=1)
rna_use.write('data/RNA/RNA_noastro_v3.2cellrank.h5ad')
